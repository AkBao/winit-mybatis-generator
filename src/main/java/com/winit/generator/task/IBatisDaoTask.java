...
import com.winit.generator.handler.impl.IBatisDaoHandler;
import com.winit.generator.model.DaoInfo;
import com.winit.generator.model.MapperInfo;

public class IBatisDaoTask extends AbstractApplicationTask {
    private static String DAO_FTL = "template/IBatisDao.ftl";
