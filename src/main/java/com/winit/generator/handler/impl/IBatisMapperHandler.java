...
public class IBatisMapperHandler extends BaseHandler<MapperInfo> {
    public IBatisMapperHandler(String ftlName, MapperInfo info) {
      ...
      //<result column="SU_ROUTE_CODE" jdbcType="VARCHAR" property="suRouteCode" />
        ...
        for (Entry<String, String> entry : info.getEntityInfo().getPropNameColumnNames().entrySet()) {
            ...
            if (!("id".equals(propName))) {
                i++;
                resultMap.append("<!-- ").append(i).append("-->  <result column=\"").append(columnName).append("\" jdbcType=\"")
